...
test('replaces multiple instances of blacklisted words', function () {
  return expect((0, _2.default)('The name of the NX will be the Nintendo Switch. The switch is awsome!', ['switch'])).toBe('The name of the NX will be the Nintendo ***. The *** is awsome!');
});